        ...
        <div className="max-w-md w-full">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              {/* Password */}
              <div>
                <label className="block text-gray-300 mb-2 font-medium">Šifra</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  ...
                  <input type={showPassword ? "text" : "password"} name="password" value={formData.password} onChange={handleChange}
                    ...
                    placeholder="Napravite jaku lozinku" />
              ...
              <div className="flex items-start">
                ...
                <label className="ml-3 text-sm text-gray-300">
                  ...
                  {' '}i{' '}
                  <Link to="/privacy" className="text-blue-400 hover:text-blue-300">Politike Privatnosti</Link>
                </label>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-300">
                Već imate nalog?{' '}
                <Link to="/login" className="text-blue-400 hover:text-blue-300 font-semibold transition">Prijava</Link>
              </p>
            </div>
          </div>
